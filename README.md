...
| Совместимые сборки | `26.721.41059 (5848)`, `26.721.81911 (5973)`, `26.903.61454 (8378)` |
...
Для `26.903.61454 (8378)` полный адаптер проверен live-тестом 10 сентября 2026 года.
...
Поддерживаются пары `26.721.41059` / `5848`, `26.721.81911` / `5973`
и `26.903.61454` / `8378`.
